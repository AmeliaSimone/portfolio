...
import { FaLanguage, FaCertificate } from 'react-icons/fa'
...
export default function LanguagesCertifications() {
  ...
  return (
    <div className={styles.languagesCertifications}>
      ...
      <p className={`${styles.subtitle} animate-fadeIn`}>{t('languages.subtitle')}</p>

      <div className={styles.content}>
        <div className={`${styles.section} ${styles.languages} animate-slideInFromLeft`}>
          <h3><FaLanguage className={styles.icon} /> {t('languages.title')}</h3>
          <ul>
            {languages.map((lang, index) => (
              <li key={index} className="animate-fadeIn" style={{ animationDelay: `${index * 0.2}s` }}>
        ...
        <div className={`${styles.section} ${styles.certifications} animate-slideInFromRight`}>
          <h3><FaCertificate className={styles.icon} /> {t('certifications.title')}</h3>
          <ul>
